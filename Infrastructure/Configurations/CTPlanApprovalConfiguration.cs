...
{
    public class CTPlanApprovalConfiguration : IEntityTypeConfiguration<CTPlanApproval>
    {
        public void Configure(EntityTypeBuilder<CTPlanApproval> builder)
        {
            builder.ToTable("CTPlanApproval").HasKey(p => p.CTPlanApprovalId)
                .HasName("PK_CTPlanApproval");
            builder.Property(p => p.CTPlanApprovalId)
                .ValueGeneratedOnAdd();
