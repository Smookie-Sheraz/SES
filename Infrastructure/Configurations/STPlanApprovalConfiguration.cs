...
{
    public class STPlanApprovalConfiguration : IEntityTypeConfiguration<STPlanApproval>
    {
        public void Configure(EntityTypeBuilder<STPlanApproval> builder)
        {
            builder.ToTable("STPlanApproval").HasKey(p => p.STPlanApprovalId)
                .HasName("PK_STPlanApproval");
            builder.Property(p => p.STPlanApprovalId)
                .ValueGeneratedOnAdd();
