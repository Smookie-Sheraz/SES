...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230125071838_TeachMethodChapSLO")]
    partial class TeachMethodChapSLO
    {
            ...
            modelBuilder.Entity("Entities.Models.Topic", b =>
                {
                    ...
                    b.Property<string>("TeachingMethodDesc")
                        .HasColumnType("varchar(max)");
            ...
            modelBuilder.Entity("Entities.Models.Topic", b =>
                {
                    ...
                    b.HasOne("Entities.Models.TeachingMethodology", "TeachingMethodology")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_Topic_TeachingMethodologyId");
            ...
            modelBuilder.Entity("Entities.Models.UnitAllocation", b =>
                {
                    b.HasOne("Entities.Models.Month", "Month")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_UnitAllocation_MonthId");
