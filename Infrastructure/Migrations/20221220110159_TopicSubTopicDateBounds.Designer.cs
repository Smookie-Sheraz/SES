...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20221220110159_TopicSubTopicDateBounds")]
    partial class TopicSubTopicDateBounds
    {
            ...
            modelBuilder.Entity("Entities.Models.SubTopicAllocation", b =>
                {
                    ...
                    b.Property<DateTime?>("TopicEndDate")
                        .HasColumnType("date");
                    ...
                    b.Property<DateTime?>("TopicStartDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Entities.Models.TopicAllocation", b =>
                {
                    ...
                    b.Property<DateTime?>("ChapterEndDate")
                        .HasColumnType("date");
                    ...
                    b.Property<DateTime?>("ChapterStartDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Entities.Models.SubTopicAllocation", b =>
                {
                    b.HasOne("Entities.Models.Month", "Month")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("FK_SubTopicAllocation_MonthId");
